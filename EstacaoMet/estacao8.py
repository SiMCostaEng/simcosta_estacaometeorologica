...
#     bussola_data = getBussolaInfo(uart_bussola.read())
    ...
    estacao=[counterstr,framesync,estacao]        #coloca framesync no inicio da msg
    #print(estacao)
...
while True:
    if interruptCounter > 0:
        ...
        sendMSG()
        if totalInterruptsCounter > 6: #600 representa o numero de amostras coletadas em 10 minutos
            #sendMSG()
            totalInterruptsCounter = totalInterruptsCounter - 6
