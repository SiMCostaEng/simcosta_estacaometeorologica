...
def pisca(led, quant):
    ...
    while led_state < quant:
        if interruptCounter > 0:
            interruptCounter = interruptCounter - 1
            led.value(1)
            #print('led state is: {}'.format(led_state))
            led_state += 1
    led.value(0)
    ...
    def read(self):
        ...
        if input_var == 2:
           ...
           # PROBE_CO2.inicializar()
            ...
            estacao =  co2_data + wind_data  + LM_data +  pressure_data + probe_thr_data 
            ...
            print(len(estacao_comma_separated))
